...
static int FixTwoBitsErrors(std::array<uint8_t, Message::LongMessageBytes>& msg, size_t bits)
{
    size_t j = 0;
    size_t i = 0;
 ...
 * structure. */
Message ADSB1090Handler::DecodeModesMessage(std::array<uint8_t, Message::LongMessageBytes> const& msgIn)
{
    Message     mm{};
